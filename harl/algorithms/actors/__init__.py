...
from harl.algorithms.actors.clip_happo import ClipHAPPO
from harl.algorithms.actors.clip_hatrpo import ClipHATRPO
...
ALGO_REGISTRY = {
    ...
    "maddpg": MADDPG,
    "mappo": MAPPO,
    "clip_happo": ClipHAPPO,
    "clip_hatrpo": ClipHATRPO,
}
